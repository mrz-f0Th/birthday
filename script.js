function message() {
    const message = "happy birthday nabila",
...
const button = document.querySelector('.button-birthday');
const gifAnimation = document.querySelector('.gif-animation');
const body = document.querySelector('body');
const birthdaySound = document.querySelector('#birthday-sound');

gifAnimation.addEventListener('animationend', () => {
